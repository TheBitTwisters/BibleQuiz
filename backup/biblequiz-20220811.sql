...
CREATE TABLE IF NOT EXISTS `attendances` (
  ...
  CONSTRAINT `fk_attendance_user` FOREIGN KEY (`user_id`) REFERENCES `members` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dumping data for table biblequiz.choices: ~197 rows (approximately)
...
REPLACE INTO `games` (`id`, `active`, `title`, `date`, `current_question_id`, `created_at`) VALUES
	...
	(4, 1, 'Matthew 13 to 20', '2022-08-06', 112, '2022-08-07 11:30:44');
...
-- Dumping data for table biblequiz.groups: ~11 rows (approximately)
...
-- Dumping data for table biblequiz.members: ~21 rows (approximately)
...
REPLACE INTO `members` (`id`, `active`, `group_id`, `last_name`, `first_name`, `registered_at`) VALUES
	...
	(4, 1, NULL, 'Sebes', 'Cassandra', '2022-07-07 00:35:56'),
	(5, 1, 3, 'Patricio', 'Christian', '2022-07-07 00:36:19'),
	(6, 1, NULL, 'Manaytay', 'Elmer', '2022-07-07 00:36:48'),
	(7, 1, 2, 'Cuaresma', 'James', '2022-07-07 00:37:29'),
	(8, 1, NULL, 'Razon', 'Rose Jewel', '2022-07-07 00:37:43'),
	(9, 1, NULL, 'Sebes', 'John Dave', '2022-07-07 00:38:22'),
	...
	(13, 1, NULL, 'Vidad', 'Ralph', '2022-07-07 00:39:23'),
	(14, 1, NULL, 'Villas', 'Ralph', '2022-07-07 00:39:36'),
	(15, 1, 2, 'Cuaresma', 'Rovielyn', '2022-07-07 00:39:48'),
	(16, 1, NULL, 'Vidad', 'Ronie', '2022-07-07 00:39:55'),
	(17, 1, NULL, 'Garcia', 'Shiena', '2022-07-07 00:40:03'),
	(18, 1, NULL, 'Pascua', 'Trician James', '2022-07-07 00:40:19'),
	(19, 1, 8, 'Acido', 'Karen', '2022-07-09 15:32:29'),
	(20, 1, 8, 'Acido', 'Lea', '2022-07-09 15:32:39'),
	(22, 1, 3, 'Cuaresma', 'Jocelyn', '2022-08-11 18:26:40'),
	(24, 1, NULL, 'Teofilo', 'Reyna', '2022-08-11 18:28:32'),
	(26, 1, 6, 'Arevalo', 'Christopher', '2022-08-11 18:32:39'),
	(27, 1, NULL, 'Velchez', 'Christian', '2022-08-11 18:33:03');
...
-- Dumping data for table biblequiz.questions: ~91 rows (approximately)
