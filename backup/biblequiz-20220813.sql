...
-- Dumping data for table biblequiz.attendances: ~1 rows (approximately)
...
-- Dumping data for table biblequiz.choices: ~211 rows (approximately)
...
-- Dumping data for table biblequiz.games: ~4 rows (approximately)
...
-- Dumping data for table biblequiz.gamescores: ~0 rows (approximately)
