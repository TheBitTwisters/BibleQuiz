...
-- Dumping data for table biblequiz.answers: ~302 rows (approximately)
...
REPLACE INTO `games` (`id`, `active`, `title`, `date`, `current_question_id`, `created_at`) VALUES
	...
	(2, 1, 'Matthew 1 to 6', '2022-07-02', 59, '2022-07-06 22:58:52'),
...
-- Dumping data for table biblequiz.gamescores: ~32 rows (approximately)
